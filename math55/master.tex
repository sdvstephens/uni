...
\lecture{9}{hermatians, \( \CC\)-spectrals, etc.}{October 10, 2025}
...
\begin{definition}[hermation forms]
...
\begin{definition}[hermation inner products]
...
\begin{definition}[complex spectral theorem]
  put it here 
\end{definition}
